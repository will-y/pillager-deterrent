...
public class PillagerDeterrentChestLootTables implements LootTableSubProvider {
    public static ResourceLocation RESOURCE_LOCATION = PillagerDeterrent.rl("pillager_outpost");

    public PillagerDeterrentChestLootTables(HolderLookup.Provider lookupProvider) {

    }

    public PillagerDeterrentChestLootTables() {

    }

    @Override
    public void generate(BiConsumer<ResourceLocation, LootTable.Builder> output) {
        output.accept(RESOURCE_LOCATION,
                LootTable.lootTable()
